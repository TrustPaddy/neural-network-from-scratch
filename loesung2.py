"""
Lösung 2: Nichtlineares Zielproblem
    x1 = q1 + q2² - 1
    x2 = q1 - q2 + 1

Architektur: [2, 2, 4, 2]  (hidden: paraReLU → tanh, output: linear)
Optimierer:  AdamW
"""
...
plt.grid(True)
plt.title("Lösung 2 – Training Loss")
plt.tight_layout()
plt.savefig("loss_loesung2.png", dpi=150)
plt.show()

# ── Schnelltest ─────────────────────────────────────────────────
q_test = np.array([[0.75, -0.25]])
# Erwartung: x1 = 0.75 + 0.0625 - 1 = -0.1875,  x2 = 0.75 + 0.25 + 1 = 2.0
